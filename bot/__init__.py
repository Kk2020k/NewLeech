...
SHORTENER = environ.get('SHORTENER', 'dulink.in')
SHORTENER_API = environ.get('SHORTENER_API', '72861cc534bced98f51622a8bcd0b1a5ad306465')
...
if len(AUTHOR_URL) == 0:
    AUTHOR_URL = 'https://t.me/+tAL9AUaKmQ9hOWE1'
